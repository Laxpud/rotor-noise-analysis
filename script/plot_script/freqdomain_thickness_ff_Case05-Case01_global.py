...
for OBS_Number in OBS_range:
    ...
    y_name = 'SPL (dB)'
    # -----------
    data_1_path = fr'.\Case01\Case01_Rotor_OBS{OBS_Number:04d}_FreqDomain.csv'
    data_1 = pd.read_csv(data_1_path, sep=",", header=0)  # 读取数据
    data_2_path = fr'.\Case05\Case05_Rotor_OBS{OBS_Number:04d}_FreqDomain.csv'
    ...
    # ----------- 线图
    x_data_1, y_data_1 = data_1['Frequency(Hz)'], data_1['SPL_Thickness(dB)']
    x_data_2, y_data_2 = data_2['Frequency(Hz)'], data_2['SPL_FF_Thickness(dB)']
