...
y_name = 'Load SPL (dB)'
# -----------
data_1_path = fr"data\Case01\Case01_Rotor_OBS{OBS_Number:04d}_SPLs.csv"
data_1 = pd.read_csv(data_1_path, sep=",", header=0)  # 读取数据
# data_2_path = fr"data\Case02\Case02_Rotor_OBS{OBS_Number:04d}_SPLs.csv" # 发现数据错误，弃用。
# data_2 = pd.read_csv(data_2_path, sep=",", header=0)  # 读取数据
data_3_path = fr"data\Case03\Case03_Rotor_OBS{OBS_Number:04d}_SPLs.csv"
data_3 = pd.read_csv(data_3_path, sep=",", header=0)  # 读取数据
data_4_path = fr"data\Case04\Case04_Rotor_OBS{OBS_Number:04d}_SPLs.csv"
data_4 = pd.read_csv(data_4_path, sep=",", header=0)  # 读取数据
data_5_path = fr"data\Case05\Case05_Rotor_OBS{OBS_Number:04d}_SPLs.csv"
...
# ----------- 线图
x_data_1, y_data_1 = data_1['Cycle'], data_1['SPL_Load(dB)']
# x_data_2, y_data_2 = data_2['Cycle'], data_2['SPL_FF_Load(dB)']
x_data_3, y_data_3 = data_3['Cycle'], data_3['SPL_FF_Load(dB)']
x_data_4, y_data_4 = data_4['Cycle'], data_4['SPL_FF_Load(dB)']
x_data_5, y_data_5 = data_5['Cycle'], data_5['SPL_FF_Load(dB)']
