...
for OBS_Number in OBS_range:
    ...
    y_name = 'SPL (dB)'
    # -----------
    data_1_path = fr"data\Case04\Case04_Rotor_OBS{OBS_Number:04d}_HarmonicContribution.csv"
    ...
    ax.scatter(data_1['Harmonic Order'], data_1['FF_Unsteady Load SPL(dB)'], label='Unsteady Load', color=colors[2], marker='^', alpha=0.8, zorder=2, linewidths=scatter_lw)
