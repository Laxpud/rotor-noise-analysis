...
# -----------
data_1_path = r'.\data\Cn\Case04_Cn_distribution.csv'
...
# ============================================================
# 第 2 步：截取指定圈数的数据
# 每 360°（2°/行 × 180 行）为完整一圈；多取 1 行是为了极坐标首尾闭合
# ============================================================
cycle = 12
cycle_start_deg = 360 * (cycle - 1)            # 第 12 圈的起始方位角
...
Z = data_1_cycle[r_cols].values                 # Z: Cn 的值矩阵
