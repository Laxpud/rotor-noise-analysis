...
# ----------- 散点图
# 数据
ax.scatter(data_1['Harmonic Order'], data_1['SPL_FF_Load(dB)'], label='Free-field', color='grey', marker='o', alpha=0.5, zorder=3, linewidths=scatter_lw)
ax.scatter(data_1['Harmonic Order'], data_1['SPL_SR_Load(dB)'], label='Reflected', color=colors[0], marker='s', alpha=0.8, zorder=2, linewidths=scatter_lw)
ax.scatter(data_1['Harmonic Order'], data_1['SPL_merged_Load(dB)'], label='Combined', color=colors_wong[1], marker='^', alpha=0.8, zorder=2, linewidths=scatter_lw)
