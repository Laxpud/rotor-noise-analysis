...
# ----------- 散点图
# 数据
ax.plot(data_1['Harmonic Order'], data_1['SPL_FF_Thickness(dB)'], label='Free-field', color='grey', marker='o', alpha=0.5, zorder=3, linestyle='none')
ax.plot(data_1['Harmonic Order'], data_1['SPL_SR_Thickness(dB)'], label='Reflected', color=colors[0], marker='s', alpha=0.8, zorder=2, linestyle='none')
ax.plot(data_1['Harmonic Order'], data_1['SPL_merged_Thickness(dB)'], label='Combined', color=colors_wong[1], marker='^', alpha=0.8, zorder=2, linestyle='none')
